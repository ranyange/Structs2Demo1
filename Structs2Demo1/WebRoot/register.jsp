...
<body>
	...
	<div class="container" style="margin-top: 10%; font-family: fantasy; margin-top: 10%; font-family: fantasy;position:absolute;z-index:4;width: 1300px; left:30px; top:80px;">
		<section id="content">
			<form action="<%=path %>/test/registerAction_1" method='post'>
				<h1>注册用户</h1>
				<div>
					<input type="text" placeholder="用户名" required="" name="user.username" style="background:url(./images/2.png) no-repeat; "/>
				</div>
				<div>
					<input type="text" placeholder="昵称" required="" name="user.nickname" style="background:url(./images/2.png) no-repeat; "/>
				</div>
				<div>
					<input type="password" placeholder="密码" required="" name="user.password" style="background:url(./images/1.png) no-repeat; "/>
				</div>
				<div>
